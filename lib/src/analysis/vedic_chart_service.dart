...
class VedicChartService {
  ...
  /// | Moon    | Taurus (1)  | 420   |
  /// | Mars    | Aries (0)   | 012   |
  /// | Mercury | Virgo (5)   | 1620  |
  /// | Jupiter | Sagittarius | 010   |
  /// | Venus   | Libra (6)   | 015   |
  /// | Saturn  | Aquarius(10)| 020   |
  (int, double, double)? _getMoolaTrikonaRange(Planet planet) {
    return switch (planet) {
      Planet.sun => (4, 0.0, 20.0), // Leo 020
      Planet.moon => (1, 4.0, 20.0), // Taurus 420 (03 is exaltation)
      Planet.mars => (0, 0.0, 12.0), // Aries 012
      Planet.mercury => (5, 16.0, 20.0), // Virgo 1620
      Planet.jupiter => (8, 0.0, 10.0), // Sagittarius 010
      Planet.venus => (6, 0.0, 15.0), // Libra 015
      Planet.saturn => (10, 0.0, 20.0), // Aquarius 020
      _ => null,
    };
  }
}
