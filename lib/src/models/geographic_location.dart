...
class GeographicLocation {
  ...
  String toString() {
    ...
    return 'GeographicLocation('
        'lat: ${latDMS['degrees']}${latDMS['minutes']}\'${(latDMS['seconds'] as double).toStringAsFixed(2)}"${latDMS['direction']}, '
        'lon: ${lonDMS['degrees']}${lonDMS['minutes']}\'${(lonDMS['seconds'] as double).toStringAsFixed(2)}"${lonDMS['direction']}, '
